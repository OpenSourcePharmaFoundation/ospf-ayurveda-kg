...
2. This command file itself (`.claude/commands/cancer-researcher.md`)
...
|---|---|---|
| Tarlatamab (Imdelltra) | DLL3 × CD3 | ES-SCLC (first bispecific in lung cancer, traditional approval 2025) |
| Teclistamab (Tecvayli) | BCMA × CD3 | Relapsed/refractory multiple myeloma |
| Elranatamab (Elrexfio) | BCMA × CD3 | Multiple myeloma |
| Linvoseltamab (Lynozyfic) | BCMA × CD3 | Multiple myeloma (4+ prior lines) |
| Talquetamab (Talvey) | GPRC5D × CD3 | Multiple myeloma (novel target) |
| Mosunetuzumab (Lunsumio) | CD20 × CD3 | Follicular lymphoma |
| Glofitamab (Columvi) | CD20 × CD3 | DLBCL |
| Epcoritamab (Epkinly) | CD20 × CD3 | DLBCL |
| Cadonilimab | PD-1 × CTLA-4 | Gastric cancer (COMPASSION-15: significant OS benefit) |
...
- Alpha particles ~1,000× more potent than lutetium-177 beta particles
...
| Cost trend | 30% increase in recent years; >2× over 6 years |
...
- **Curcumin** (turmeric): NF-κB inhibition, anti-inflammatory, multiple clinical trials in CRC, pancreatic, breast
